...
const Sidenav = () => {
  ...
  const title = t("avatar.brand", "Uzmat.uz");
  ...
  return (
    ...
    >
      <Box>
        <Heading textAlign="center" fontSize="20px" as="h1" pt="3.5rem">
          <HStack as="a" href="/" cursor="pointer">
            <Image src="/MlogoLight.png" objectFit={'cover'} alt="UZMAT.uz" boxSize="40px" borderRadius="md" />
      ...
      <Box mt="6" mx="3" mb="6" display={'flex'} flexDirection={'column'} gap={5}>
        <HStack
          spacing={2}
          p={1}
          bg="gray.100"
