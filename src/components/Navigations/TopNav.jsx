  ...
  const Logo = () => (
    <Heading fontWeight="medium" fontSize="28px">
      <HStack as={'a'} href='/' cursor={'pointer'}>
        <Image src="/MlogoLight.png" alt="UZMAT.uz" objectFit={'cover'} boxSize="40px" borderRadius={'md'} />
  ...
  const UserLinks = () => (
    <HStack spacing={4} fontSize="15px">
      {userData?.isCompany === true && (
        <Text as={"a"} href="/company" cursor="pointer" color={'blue.400'} >
          {t("ProfileHeader.goToBusiness", "Перейти на бизнес аккаунт")}
        </Text>
      )}
