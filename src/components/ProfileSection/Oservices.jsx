...
Пользователь имеет право на доступ к своим персональным данным, их изменение, блокирование или уничтожение путем обращения к администрации сайта.`
    },
    {
      ...
      content: `Настоящее Лицензионное соглашение (далее - "Соглашение") является юридически обязывающим документом между Вами и ТОО "U-MTS Co" (далее - "Компания") относительно использования программного обеспечения, веб-сайтов и мобильных приложений.
...
Настоящее Пользовательское соглашение (далее - "Соглашение") регулирует отношения между ТОО "U-MTS Co" (далее - "Компания") и пользователями (далее - "Пользователь") сайта UZMAT.uz и мобильных приложений.
...
const Oservices = () => {
  ...
  const tabData = [
    {
      label: t("About.privacyPolicy", "Политика конфиденциальности"),
      shortLabel: t("About.privacyPolicyShort", "Конфиденциальность"),
      icon: FiShield,
      category: "privacy",
      color: "green"
    },
    {
      label: t("About.licenseAgreement", "Лицензионное соглашение"),
      shortLabel: t("About.licenseAgreementShort", "Лицензия"),
      icon: FiFileText,
      category: "license",
      color: "blue"
    },
    {
      label: t("About.userAgreement", "Пользовательское соглашение"),
      shortLabel: t("About.userAgreementShort", "Пользователь"),
      icon: FiUsers,
      category: "user_agreement",
      color: "purple"
    },
    {
      label: t("About.contacts", "Контакты"),
      shortLabel: t("About.contacts", "Контакты"),
      icon: FiPhone,
      category: "contacts",
      color: "orange"
    }
    ...
    <VStack spacing={6} align="stretch">
      <Box>
        <Text fontSize="2xl" fontWeight="bold" color={textColor} mb={4}>
          {t("About.contactInformation", "Контактная информация")}
        </Text>
        <Text color="gray.500" mb={6}>
          {t("About.contactDescription", "Мир спецтехники - ваш надежный партнер")}
        </Text>
        <Divider />
      </Box>
        ...
        <Card bg={cardBg} shadow="sm" borderRadius="lg" border="1px solid" borderColor={borderColor}>
          <CardBody p={4}>
            <HStack spacing={3} mb={2}>
              ...
              <Text fontWeight="semibold" color={textColor}>{t("About.email", "Email")}</Text>
            </HStack>
            <Link 
              href="mailto:info@umts.uz" 
              color="blue.500" 
        ...
        <Card bg={cardBg} shadow="sm" borderRadius="lg" border="1px solid" borderColor={borderColor}>
          <CardBody p={4}>
            <HStack spacing={3} mb={2}>
              ...
              <Text fontWeight="semibold" color={textColor}>{t("About.phone", "Телефон")}</Text>
            </HStack>
            <Text color={textColor} fontSize="sm">+998 20 005 9890</Text>
          </CardBody>
        </Card>
        ...
        <Card bg={cardBg} shadow="sm" borderRadius="lg" border="1px solid" borderColor={borderColor}>
          <CardBody p={4}>
            <HStack spacing={3} mb={2}>
              ...
              <Text fontWeight="semibold" color={textColor}>{t("About.website", "Веб-сайт")}</Text>
            </HStack>
            <Link 
              href="https://UZMAT.uz" 
              isExternal 
        ...
        <Card bg={cardBg} shadow="sm" borderRadius="lg" border="1px solid" borderColor={borderColor}>
          <CardBody p={4}>
            <HStack spacing={3} mb={2}>
              ...
              <Text fontWeight="semibold" color={textColor}>{t("About.address", "Адрес")}</Text>
            </HStack>
            <Text color={textColor} fontSize="sm">
              {t("About.addressValue", "г. Ташкент, Узбекистан")}
            </Text>
          </CardBody>
        </Card>
      </SimpleGrid>
        ...
        <CardBody p={6}>
          <VStack spacing={4} align="stretch">
            <HStack spacing={3}>
              ...
              <Text fontWeight="semibold" color={textColor}>{t("About.aboutCompany", "О компании")}</Text>
            </HStack>
            <Text color={textColor} fontSize="sm" lineHeight="1.6">
              {t("About.companyInfo", `ТОО "U-MTS Co" - ведущая платформа по продаже и аренде специальной техники в Узбекистане. 
              ...
              >
                ...
                <Box flex={1} w={"100%"}>
                  <Text fontSize={{ base: '16px', md: '20px' }} fontWeight="bold" color={textColor}>
                    {t("About.companyName","UZMAT.uz")}
                  </Text>
                  <Text color="gray.500" fontSize="sm" lineHeight={"1.2"}>
                    {t("About.companyDescription", "Мир спецтехники - правовая информация")}
                  </Text>
                </Box>
              </Stack>
            </CardBody>
