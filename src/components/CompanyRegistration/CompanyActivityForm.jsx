              ...
              {showAlert && (
                ...
                >
                  ...
                  <AlertDescription fontSize={{ base: "sm", md: "md" }} color="blue.700">
                    По выбранному типу, вам будут поступать заказы от клиентов
                  </AlertDescription>
                  <IconButton
                ...
                <VStack spacing={2} align="flex-start">
                  {formData.orderSettings.length > 0 && (
                    <Text fontSize={{ base: "sm", md: "md" }} color="gray.600">
                      Настройки заказов: <Badge colorScheme="blue">{formData.orderSettings.length}</Badge>
                    </Text>
                  )}
                  {formData.techTypes.length > 0 && (
                    <Text fontSize={{ base: "sm", md: "md" }} color="gray.600">
                      Типы техники: <Badge colorScheme="green">{formData.techTypes.length}</Badge>
                    </Text>
                  )}
                  {formData.workingBrands.length > 0 && (
                    <Text fontSize={{ base: "sm", md: "md" }} color="gray.600">
                      Марки: <Badge colorScheme="purple">{formData.workingBrands.length}</Badge>
                    </Text>
                  )}
                </VStack>
              </Box>
