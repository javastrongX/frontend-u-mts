...
import OrdersFilter from '../../ProfileSection/OrdersFilter'
...
import { ApplicationsTable } from '../../ProfileSection/ApplicationsTable';
import { OrdersTable } from '../../ProfileSection/OrdersTable';
...
const MyApplication = () => {
  ...
  const path_ads = location.pathname === "/my-products";
