...
const FilterBlock = () => {
  ...
  const categories = [
    { name: t("filter_block.sell_special_tech"), link: "/ads?category_id=1" },
    { name: t("filter_block.rent"), link: "/ads?category_id=2" },
    { name: t("filter_block.spare_parts"), link: "/ads?category_id=3" },
    { name: t("filter_block.repair"), link: "/ads?category_id=4" },
    { name: t("filter_block.drivers"), link: "/ads?category_id=5" },
  ];
