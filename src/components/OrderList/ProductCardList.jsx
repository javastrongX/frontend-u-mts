        ...
        >
          ...
          <HStack spacing={3} align="center" flexShrink={0}>
            ...
            <HStack spacing={1}>
              ...
              <Text fontSize="sm">{stats.views}</Text>
            </HStack>

            {/* Likes soni ko'rsatish (ixtiyoriy) */}
            {stats.likes > 0 && (
              <HStack spacing={1}>
                <Icon as={FaHeart} size="12px" color="red.400" />
                <Text fontSize="sm">{stats.likes}</Text>
              </HStack>
            )}
          </HStack>
        </Flex>
